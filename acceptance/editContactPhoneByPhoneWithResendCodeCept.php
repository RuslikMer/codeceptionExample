...
if($loginError == 0){
    $I->goToProfile();
    $I->editContactPhoneNumber(PHONE_EDIT_CONTACT_SECOND, PHONE_EDIT_CONTACT_FIRST, USERNAME_EDIT_CONTACT_PHONE_BY_PHONE, true);
}
...
$editPhone->does(function (AcceptanceTester $I) {
    ...
    $I->goToProfile();
    $I->editContactPhoneNumber(PHONE_EDIT_CONTACT_FIRST, PHONE_EDIT_CONTACT_SECOND, USERNAME_EDIT_CONTACT_PHONE_BY_PHONE, true);
});
$editPhone->leave();
